...
\newcommand{\heading}[3]{\centering{\sffamily\Huge #1}\\\smallskip{\large{#2}}\\\smallskip{\small{#3}}\\}
...
\begin{paracol}{2}
    ...
    % Name & headline
    \heading{Semir Ramovic}{Our life is what our thoughts make it.}{29 years old \textperiodcentered{} Graz, Austria }
    ...
    \entry{Easelink}{Senior Software Developer}{Graz, Austria}{2018-Now}
